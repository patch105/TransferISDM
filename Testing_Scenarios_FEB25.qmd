...
cov.rep2.bias <- c(cov.rep.bias, cov3)

cov.rep3.no.bias <- c(cov.rep, cov3)
...
# Integrated model with bias covariate and 3rd covariate
Model$m.int.3rd.cov.bias <- isdm(observationList = list(POdat = PO,
                                     PAdat = PA_fit),
              covars = cov.rep2.bias,
              mesh = mesh.default,
              responseNames = c(PO = NULL, PA = "presence"),
              sampleAreaNames = c(PO = NULL, PA = "area"),
...
# Integrated model with no bias covariate but a 3rd covariate
Model$m.int.3rd.cov <- isdm(observationList = list(POdat = PO,
                                     PAdat = PA_fit),
              covars = cov.rep3.no.bias,
              mesh = mesh.default,
              responseNames = c(PO = NULL, PA = "presence"),
              sampleAreaNames = c(PO = NULL, PA = "area"),
              distributionFormula = distributionFormula2,
