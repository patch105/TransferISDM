#######################################################
#######################################################
# NOW THE VERSION WITHOUT BIAS COVARIATE ----------------------------------
#######################################################
#######################################################
...
true.validation.df <- true.validation.df %>%
  ...
  mutate(bias.type2 = ifelse(grepl("bias", mod.type, fixed = T), "Bias", "No Bias")) %>%
...
final.df$bias.type2 <- factor(final.df$bias.type2, levels = c("No Bias", "Bias"))
...
ggsave(plot = fig2, filename = paste0(file.path(result_path),"/Scenario_5_tests/projection_siteNB.png"), w = 21, h = 27, units = "cm", dpi = 400, device = "png")
...
ggsave(plot = fig2b, filename = paste0(file.path(result_path),"/Scenario_5_tests/projection_siteV2NB.png"), w = 21, h = 30, units = "cm", dpi = 400, device = "png")
...
final.extrap.df.save <- final.extrap.df
...
ggsave(plot = Supp.Fig.X, filename = paste0(file.path(result_path),"/Scenario_5_tests/CoefficientsNB.png"), w = 21, h = 17.5, units = "cm", dpi = 400, device = "png")
...
ggsave(plot = Supp.Fig.X, filename = paste0(file.path(result_path),"/Scenario_5_tests/InterceptsNB.png"), w = 23.5, h = 15, units = "cm", dpi = 400, device = "png")
...
ggsave(plot = Supp.Fig.X, filename = paste0(file.path(result_path),"/Scenario_5_tests/Coefficient_SDsNB.png"), w = 21, h = 17.5, units = "cm", dpi = 400, device = "png")
...
ggsave(plot = Supp.Fig.X, filename = paste0(file.path(result_path),"/Scenario_5_tests/True_vs_estimated_GRF_paramsNB.png"), w = 21, h = 17.5, units = "cm", dpi = 400, device = "png")
...
final.SiteA.df.save <- final.SiteA.df
...
ggsave(plot = fig2, filename = paste0(file.path(result_path),"/Scenario_5_tests/training_siteNB.png"), w = 21, h = 27, units = "cm", dpi = 400, device = "png")
...
ggsave(plot = fig2b, filename = paste0(file.path(result_path),"/Scenario_5_tests/training_siteNB.png"), w = 21, h = 30, units = "cm", dpi = 400, device = "png")
...
ggsave(plot = Fig.4, filename = paste0(file.path(result_path),"/Scenario_5_tests/Correlation_random_fixed_GRF_paramsNB.png"), w = 21, h = 24, units = "cm", dpi = 400, device = "png")

ggsave(plot = Fig.4b, filename = paste0(file.path(result_path),"/Scenario_5_tests/RMSE_random_fixedNB.png"), w = 21, h = 24, units = "cm", dpi = 400, device = "png")
...
ggsave(plot = plot1, filename = paste0(file.path(result_path),"/Scenario_5_tests/Correlation_random_vs_Av_Dist_CoefNB.png"), w = 21, h = 24, units = "cm", dpi = 400, device = "png")
...
ggsave(plot = plot1b, filename = paste0(file.path(result_path),"/Scenario_5_tests/RMSE_random_vs_Av_Dist_CoefNB.png"), w = 21, h = 24, units = "cm", dpi = 400, device = "png")
...
ggsave(plot = plot2, filename = paste0(file.path(result_path),"/Scenario_5_tests/Correlation_random_vs_Beta1SDNB.png"), w = 21, h = 24, units = "cm", dpi = 400, device = "png")
...
ggsave(plot = plot2b, filename = paste0(file.path(result_path),"/Scenario_5_tests/RMSE_random_vs_Beta1SDNB.png"), w = 21, h = 24, units = "cm", dpi = 400, device = "png")
...
ggsave(plot = plot3, filename = paste0(file.path(result_path),"/Scenario_5_tests/Correlation_random_vs_Beta2SDNB.png"), w = 21, h = 24, units = "cm", dpi = 400, device = "png")
...
ggsave(plot = plot3b, filename = paste0(file.path(result_path),"/Scenario_5_tests/RMSE_random_vs_Beta2SDNB.png"), w = 21, h = 24, units = "cm", dpi = 400, device = "png")
...
ggsave(plot = plot4, filename = paste0(file.path(result_path),"/Scenario_5_tests/Correlation_random_vs_POINTNB.png"), w = 21, h = 24, units = "cm", dpi = 400, device = "png")
...
ggsave(plot = plot5, filename = paste0(file.path(result_path),"/Scenario_5_tests/Correlation_random_vs_PAINTNB.png"), w = 21, h = 24, units = "cm", dpi = 400, device = "png")
...
ggsave(plot = plot6, filename = paste0(file.path(result_path),"/Scenario_5_tests/Correlation_random_vs_ProjectionRMSENB.png"), w = 21, h = 24, units = "cm", dpi = 400, device = "png")
...
ggsave(plot = plot7, filename = paste0(file.path(result_path),"/Scenario_5_tests/Correlation_random_vs_ProjectionIntScoreNB.png"), w = 21, h = 24, units = "cm", dpi = 400, device = "png")
...
ggsave(plot = plot8, filename = paste0(file.path(result_path),"/Scenario_5_tests/Correlation_random_vs_TrainingRMSENB.png"), w = 21, h = 24, units = "cm", dpi = 400, device = "png")
...
ggsave(plot = plot9, filename = paste0(file.path(result_path),"/Scenario_5_tests/Correlation_random_vs_TrainingIntscoreNB.png"), w = 21, h = 24, units = "cm", dpi = 400, device = "png")
...
ggsave(plot = plot10, filename = paste0(file.path(result_path),"/Scenario_5_tests/Correlation_SiteAB_vs_ProjectionRMSENB.png"), w = 21, h = 24, units = "cm", dpi = 400, device = "png")
...
ggsave(plot = plot11, filename = paste0(file.path(result_path),"/Scenario_5_tests/Correlation_SiteAB_vs_ProjectionMean.Int.ScoreNB.png"), w = 21, h = 24, units = "cm", dpi = 400, device = "png")
...
ggsave(plot = Fig.4, filename = paste0(file.path(result_path),"/Scenario_5_tests/Correlation_random_fixed_GRF_paramsC.png"), w = 21, h = 24, units = "cm", dpi = 400, device = "png")

Fig.4b <- ggarrange(RMSE_GRF_FIXED_plot, g1 + rremove("xlab"), g2, ncol = 1, nrow = 3, labels = c("(a)", "(b)", "(c)"))

ggsave(plot = Fig.4b, filename = paste0(file.path(result_path),"/Scenario_5_tests/RMSE_random_fixedC.png"), w = 21, h = 24, units = "cm", dpi = 400, device = "png")
